...
class GroupList extends React.Component {
    constructor() {
        ...
        this.handleHidemodal = () => {
            this.setState({ isGroupModalShow: false });
    ...
    UpdateListGroup(){
        ...
        let setStateInRequest = (list) => { this.setState({ listGroup: list }) }
        return agent.GroupApi.listGroup(search, page
        ).then(function (res) {
    ...
    render() {
        var search = qs.parse(this.props.location.search).search;
        const data = this.state.listGroup;
        if (!data) {
            return null; }
        var currentNo = 0;
        var page = qs.parse(this.props.location.search).page;
                        ...
                        <ul className="icons-list">
                            <li className="dropdown">
                                ...
                                <ul className="dropdown-menu dropdown-menu-right">
                                    ...
                                    <li><a onClick={() => this.deleteGroup(item.id)}><i className="icon-cross2"></i>Xóa</a></li>
                                </ul>
                            </li>
                        </ul>
                    </td>
            ...
            <div className="page-header page-header-default">
                <div className="breadcrumb-line">
                    <ul className="breadcrumb">
                        ...
                        <li className="active">Liều Thuốc</li>
                    </ul>
                        ...
                        <form className="main-search" role="form">
                                        <div className="input-group content-group">
                                            <div className="has-feedback has-feedback-left">
                                                <input type="text" className="form-control input-xlg" placeholder="Tìm kiếm theo tên mẫu..." name="search" defaultValue={search} autoFocus={true} />
                                ...
                                <table className="table table-xxs table-bordered">
                                    <thead>
                                        <tr className="bg-teal">
                                            ...
                                            <th data-toggle="true">Tên Liều Thuốc</th>
                            ...
                            {this.state.isGroupModalShow ? <ModalGroup 
                                title={this.state.idGroup?"Chỉnh Sửa Liều Thuốc":"Thêm Liều Thuốc"}
                                idGroup={this.state.idGroup} 
                                show={this.state.isGroupModalShow} 
                                onHide={this.handleHidemodal} /> : null
                            }
                            <TablePagination data={data} baseUrl="/listGroup" />
                        </div>
                    </div>
                </div>
            </div>
...
export default translate('translations')(GroupList);