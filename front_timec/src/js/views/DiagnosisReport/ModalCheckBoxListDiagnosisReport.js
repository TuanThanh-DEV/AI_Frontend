...
const mapDispatchToProps = dispatch => ({
    ...
    updateField: (fieldName, value) =>
        dispatch({
            meta: { form: "ModalCheckBoxListDiagnosisReport", field: fieldName },
            payload: value,
            type: "@@redux-form/CHANGE"
        })
});
class ModalCheckBoxListDiagnosisReport extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            checked: [],
    ...
    getlistAllDiagnosisService() {
        ...
        // } else {
        //     return agent.DiagnosisServiceApi.listBhytDiagnosisService(
        //     ).then(function (res) {
        //         var result = res.resultData;
        //         if (result) {
        //             setStateInRequest(result);
    ...
    getListCheckDiagnosisService(prescriptionId) {
        ...
        return agent.asyncRequests.get('/diagnosisReport/listdiagnosisReportByDiagnosisService?prescriptionId=' + prescriptionId
        ).then(function (res) {
    ...
    handleAdd() {
        ...
        var url = '/diagnosisReport/addListDiagnosisService';
        var bodyObject = {
...
export default translate('translations')(connect(
    mapStateToProps, mapDispatchToProps)(
        reduxForm({
            form: 'ModalCheckBoxListDiagnosisReport',
            destroyOnUnmount: true,
            enableReinitialize: true,
            validate
        })(ModalCheckBoxListDiagnosisReport)));
