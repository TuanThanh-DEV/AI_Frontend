...
import PackageItemRow from '../PackageItem/PackageItemRow';
...
class PackageList extends React.Component {
    ...
    updateListPackage() {
        ...
        let setStateInRequest = (list) => { this.setState({ listPackage: list }) }
        return (agent.PackageApi.listPackage(search, page
        ).then(function (res) {
    ...
    render() {
        ...
        var search=qs.parse(this.props.location.search).search;
        const data = this.state.listPackage;
        if(!data)
        {
            return null;
        }
        ...
        var rows = data.content.map(item => {
            ...
            return (
                ...
                //                         <li><a onClick={() => this.deletePackage(item.id)}><i className="icon-cross2"></i>Xóa</a></li> 
                //                     </SecuredComponent>
                ...
                //     </td>
                // </tr>
                <PackageItemRow key={"package_" + item.id}
                    packageItemObject={item}
                    handleShowmodal={this.handleShowmodal}
                    handleHidemodal={this.handleHidemodal}
                    updateListPackage={this.updateListPackage}
                >
                </PackageItemRow>
                );
        });
            ...
            <div className="page-header page-header-default">
                <div className="breadcrumb-line">
                    <ul className="breadcrumb">
                        ...
                        <li className="active">Quản Lý </li>
            ...
            <div className="content">
                <div className="row">                    
                        ...
                        <form className="main-search" role="form">
                                ...
                                <table className="table table-togglable table-hover">
                                    <thead>
                                        <tr className="bg-teal">
                                            ...
                                            <th data-toggle="true">Tên gói khám</th>
                                            <th data-toggle="true">Mã gói khám</th>
                                            <th data-toggle="true">Giá gói khám </th>
                            ...
                            <TablePagination data={data} baseUrl="/listPackage" />
                        </div>
                    </div>
                </div>
...
export default translate('translations')(connect(mapStateToProps, mapDispatchToProps)(PackageList));