...
class CouponList extends React.Component {
    constructor() {
        ...
        this.handleHidemodal = () => {
            this.setState({ isCouponModalShown: false });
            this.updateListCoupon();
        };
    };
    ...
    updateListCoupon() {
        ...
        return (agent.CouponApi.listCoupon(search, page
        ).then(function (res) {
    ...
    render() {
        ...
        var search = qs.parse(this.props.location.search).search;
        const data = this.state.listCoupon;
        if (!data) {
            return null;
        }
                            ...
                            <li className="dropdown">
                                ...
                                <ul className="dropdown-menu dropdown-menu-right">
                                    ...
                                    <SecuredComponent allowedPermission="admin.users.delete">
                                        ...
                                        <li><a onClick={() => this.deleteCoupon(item.id)}><i className="icon-cross2"></i>Xóa</a></li>
                                    </SecuredComponent>
                ...
                <div className="page-header page-header-default">
                    <div className="breadcrumb-line">
                        <ul className="breadcrumb">
                            ...
                            <li className="active">Quản Lý Mã Giảm Giá</li>
                            <li className="active">Mã Giảm Giá</li>
                        </ul>
                ...
                <div className="content">
                    <div className="row">
                        <div className="col-md-12">
                                ...
                                <table className="table table-togglable table-hover">
                                    <thead>
                                        <tr className="bg-teal">
                                            ...
                                            <th data-toggle="true">Phần trăm giảm giá </th>
                            ...
                            {this.state.isCouponModalShown ? <ModalCoupon
                                title={this.state.idCoupon ? "Chỉnh Sửa Mã Giảm Giá" : "Thêm Mã Giảm Giá"}
                                idCoupon={this.state.idCoupon}
                                show={this.state.isCouponModalShown}
                                onHide={this.handleHidemodal} /> : null}

                            <TablePagination data={data} baseUrl="/listCoupon" />
                        </div>
                    </div>
                </div>
...
export default translate('translations')(connect(mapStateToProps, mapDispatchToProps)(CouponList));