            ...
            <div className="page-header page-header-default">
                <div className="breadcrumb-line">
                    <ul className="breadcrumb">
                        ...
                        <li className="active">Danh Sách Nhà Cung Cấp Thiết Bị</li>
                    </ul>
            ...
            <div className="content">
                <div className="row">                    
                        ...
                        <form className="main-search" role="form">
                            ...
                            {this.state.isSupplierModalShown ? <ModalSupplier 
                                title= {this.state.idSupplier ? "Chỉnh Sửa Nhà Cung Cấp" : "Thêm Nhà Cung Cấp"} 
