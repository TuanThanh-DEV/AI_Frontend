...
class ModalOutputRefundCompany extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
                    ...
                    <Modal.Body>
                        {submitting ? <LoadingScreen /> :
                            <form className="form-horizontal" role="form" onSubmit={handleSubmit(this.handleAdd)}>
                                ...
                                {/* <Field name="toDrugStoreId" label="Chọn Kho Nhận Thuốc (*)"    placeholder="Chọn Kho Nhận..." options={optionDrugStore} component={RenderSelect}></Field> */}
                                <Field name="supplierId" label="Công Ty Dược/Nhà Cung Cấp"    placeholder="Chọn ..." options={optionSupplier} component={RenderSelect}></Field>
...
export default translate('translations')(connect(
    mapStateToProps, mapDispatchToProps)(
        reduxForm({
            form: 'ModalOutputRefundCompany',
            destroyOnUnmount: true,
            enableReinitialize: true,
            validate
        })(ModalOutputRefundCompany)));
