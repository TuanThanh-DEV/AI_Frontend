...
const selector = formValueSelector("CheckFollowInput");
...
const mapDispatchToProps = dispatch => ({
    updateField: (fieldName, value) =>
        dispatch({
            meta: { form: "CheckFollowInput", field: fieldName },
            payload: value,
            type: "@@redux-form/CHANGE"
        })
});

class CheckFollowInput extends React.Component {
    constructor() {
        super();
        this.state = {
            listStock: null,
    ...
    handleSearchForm(values) {
        ...
        return agent.asyncRequests.get('/report/checkInputReport?fromDate=' + fromDate + '&toDate=' + toDate
                ...
                <div className="page-header page-header-default">
                    <div className="breadcrumb-line">
                        <ul className="breadcrumb">
                            ...
                            <li className="active">Thẻ Nhập Kho</li>
                        </ul>
                        ...
                        <table className="table table-xxs table-bordered" id="table-to-xls" style={{ display: 'none' }}>
                            <thead>
                                <tr className="bg-teal">
                                    ...
                                    <th data-toggle="true">Ngày Hóa Đơn</th>
                                    <th data-toggle="true">Số Hóa Đơn</th>
                                    <th data-toggle="true">Công Ty Mua</th>
                                </tr>
                            </thead>
                            <tbody>
                                {rows}
                            ...
                            <table className="table table-xxs table-bordered" id="table-screen">
                                <thead>
                                    <tr className="bg-teal">
                                        ...
                                        <th width="10%" data-toggle="true">Ngày Hóa Đơn</th>
                                        <th data-toggle="true">Số Hóa Đơn</th>
                                        <th data-toggle="true">Công Ty Mua</th>
                                    </tr>
                                </thead>
