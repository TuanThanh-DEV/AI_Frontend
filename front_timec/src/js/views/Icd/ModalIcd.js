                    ...
                    <Modal.Body>
                        {submitting ? <LoadingScreen /> :
                            <form className="form-horizontal" role="form" onSubmit={handleSubmit(this.handleAdd)}>
                                <Field name="code" label="Mã ICD (*)" placeholder="Nhập mã ICD..." component={RenderInputWithDiv}></Field>
                                <Field name="name" label="Tên ICD (*)" placeholder="Nhập tên ICD..." component={RenderInputWithDiv}></Field>
                                <Field name="codeBhyt" label="Mã BHYT" placeholder="Nhập mã BHYT..." component={RenderInputWithDiv}></Field>
