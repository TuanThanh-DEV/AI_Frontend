                ...
                <div className="content">
                    <div className="row">
                        <div className="col-md-12">
                            ...
                            {this.state.isBillingModalShown ? <ModalBilling
                                title={this.state.idBilling ? "Chỉnh Sửa Mã Số" : "Thêm Mới Mã Số"}
                                idBilling={this.state.idBilling}
                                show={this.state.isBillingModalShown}
...
export default translate('translations')(connect(mapStateToProps, mapDispatchToProps)(BillingList));