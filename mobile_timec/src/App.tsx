          ...
          <IonReactRouter>
            <IonSplitPane contentId="main">
              ...
              <IonRouterOutlet id="main">
                ...
                <Route path="/signupSuccessPage" component={SignUpSuccessPage} />
                ...
                <Route path="/appointmentSuccess" component={AppointmentSuccessPage} />
                
                <Route path="/listAppointment" component={ListAppointmentPage} />
                <Route path="/editAppointment/:appointmentId" component={EditAppointmentPage} />
